  ...
  return (
    ...
    >
      ...
      <div className="sm:hidden px-4 pt-3 pb-3">
        {/* Compact stats line */}
        <div className="flex items-center gap-2 mb-2.5 font-body text-[12px]">
          <span className="font-mono font-semibold" style={{ color: '#0F172A' }}>{totalTx.toLocaleString('id-ID')}</span>
          <span style={{ color: '#64748B' }}>transaksi</span>
          <span style={{ color: '#CBD5E1' }}>·</span>
          <span className="font-mono font-semibold" style={{ color: '#0F172A' }}>{banks}</span>
          <span style={{ color: '#64748B' }}>bank</span>
          <span style={{ color: '#CBD5E1' }}>·</span>
          <span className="font-mono font-semibold" style={{ color: '#0F172A' }}>{doneFiles}</span>
